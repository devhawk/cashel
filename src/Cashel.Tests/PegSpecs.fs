...
let test_Class_single () =
    Class !! "[a]test" === (Some([Single('a')], !!"test"))
...
let test_Class_single_range () =
    Class !! "[a-z]test" === (Some([Dual('a', 'z')], !!"test"))
    
[<Test>]
let test_Class_multiple () =
    Class !! "[ab-z]test" === (Some([Single('a');Dual('b','z')], !!"test"))
...
let test_Class_failure () =
    Class !! "ab-z]test" === None

[<Test>]
let test_Literal_single_quote () =
    Literal !! "'test'  me" === (Some(!!"test", !!"me"))
...
let test_Literal_no_end_quote () =
    Literal !! "\"test  me" === None

[<Test>]
let test_Identifier () =
    Identifier !! "tE_s9t me" === (Some(!!"tE_s9t", !!"me"))

[<Test>]
let test_Identifier_start_with_underscore () =
    Identifier !! "_9test me" === (Some(!!"_9test", !!"me"))

[<Test>]
let test_Identifier_fail_start_with_number () =
    Identifier !! "9test me" === None
